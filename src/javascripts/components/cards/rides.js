...
const showRides = (arr) => {
  ...
  if (firebase.auth().currentUser) {
    arr.forEach((item) => {
      document.querySelector('#card-container').innerHTML += `<div class="card" style="width: 18rem; height: 29em">
      <img src="${item.image}" class="card-img-top" style="height: 13em" alt="${item.name}">
